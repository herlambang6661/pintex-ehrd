                ...
                <div class="modal-content">
                    <form id="formCheckWawancara" name="formCheckWawancara" method="post" action="javascript:void(0)">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title"><i class="fa-solid fa-user-check" style="margin-right: 5px"></i> Proses Kandidat ke Wawancara</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                ...
                <form method="post" action="/testkapas/import_excel" enctype="multipart/form-data">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary ms-auto"><i class="fa-solid fa-cloud-arrow-up" style="margin-right:5px"></i> Import</button>
                        </div>
                    </div>
                </form>
            </div>
