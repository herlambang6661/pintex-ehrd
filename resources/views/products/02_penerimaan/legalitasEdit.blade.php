        ...
        <div class="page-body">
            <form id="formLegalitas" name="formLegalitas" method="post" action="javascript:void(0)">
                ...
                <div class="container-xl">
                            ...
                            <div class="card card-xl border-success shadow rounded">
                                ...
                                <div class="card-body">
                                    <h3 class="card-title d-flex">
                                        Basic Information
                                        <div class=" ms-auto">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#modal-stb" class="btn btn-secondary btn-sm"><i class="fa-solid fa-arrow-up-9-1" style="margin-right: 5px"></i> STB Terakhir</a>
                                            <button type="button" class="btn btn-icon btn-success btn-sm" onclick="tambahBasic(); return false;"><i class="fa-solid fa-add"></i></button>
                                        </div>
                                    </h3>
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-xl border-purple shadow rounded">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title d-flex">
                                                Perjanjian
                                                <button type="button" class="btn btn-icon btn-sm btn-purple ms-auto" onclick="tambahPerjanjian(); return false;"><i class="fa-solid fa-add"></i></button>
                                            </h3>
                                            <input id="idp" value="1" type="hidden">
                                            <div class="table-responsive">
                                                <table class="table table-sm table-hover table-bordered table-vcenter card-table text-nowrap border border-purple" id="tb_per">
                                                    <thead>
                                                        <tr>
                                                            <th class="w-1"></th>
                                                            <th class="text-center">Tanggal</th>
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-xl border-teal shadow rounded">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title d-flex">
                                                Internal
                                                <button type="button" class="btn btn-teal btn-icon btn-sm ms-auto" onclick="tambahInternal(); return false;"><i class="fa-solid fa-add"></i></button>
                                            </h3>
                        ...
                        <div class="col-lg-4">
                            <div class="card card-xl border-pink shadow rounded">
                                ...
                                <div class="card-body">
                                    <h3 class="card-title d-flex">
                                        Status
                                        <button type="button" class="btn btn-pink btn-icon btn-sm ms-auto" onclick="tambahStatus(); return false;"><i class="fa-solid fa-add"></i></button>
                                    </h3>
                    ...
                    <br>
                    <button class="btn btn-blue" id="simpanLegalitas"><i class="fa-solid fa-floppy-disk" style="margin-right: 5px"></i> Simpan</button>
...
<script type="text/javascript">
        ...
        if ($("#formLegalitas").length > 0) {
            $("#formLegalitas").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $('#simpanLegalitas').html('<i class="fa-solid fa-fw fa-spinner fa-spin"></i> Please Wait...');
                    ...
                    $.ajax({
                        ...
                        success: function( response ) {
                            ...
                            if (response.status == true) {
                                $('#simpanLegalitas').html('<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-device-floppy" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6 4h10l4 4v10a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2" /><path d="M12 14m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M14 4l0 4l-6 0l0 -4" /></svg> Simpan');
    ...
    function tambahBasic() {
        ...
        var td = document.createElement("td");
        td.setAttribute("class", "border border-green w-0");
        td.innerHTML += '<input type="date" style="width:110px;" value="'+tglhariini+'" name="tgl[]" id="tgl_'+idf+'">';
        tr.appendChild(td);

        // Kolom 3 Nama Surat                            
        var td = document.createElement("td");
        td.setAttribute("class", "border border-green");
        td.innerHTML += '<input type="text" style="width:180px;" value="Surat Deskripsi Pekerjaan" name="namasurat[]" id="namasurat_'+idf+'">';
        tr.appendChild(td);

        // Kolom 4 Tgl Aktif
        var td = document.createElement("td");
        td.setAttribute("class", "border border-green");
        td.innerHTML += '<input type="date" style="width:110px;" value="'+tglhariini+'" name="tglaktif[]" id="tglaktif_'+idf+'">';
        tr.appendChild(td);

        // Kolom 5 STB
        var td = document.createElement("td");
        td.setAttribute("class", "border border-green");
        td.innerHTML += "<input type='text' name='stb[]' id='stb_" + idf + "' class=' inputNone' style='width:60px;text-transform: uppercase;'>";
        tr.appendChild(td);
        ...
        var td = document.createElement("td");
        td.setAttribute("class", "border border-green");
        td.innerHTML += "<input type='text' name='profesi[]' id='profesi_" + idf + "' style='text-transform: uppercase;'>";
        tr.appendChild(td);
        ...
        var td = document.createElement("td");
        td.setAttribute("class", "border border-green");
        td.innerHTML += "<input type='text' name='keterangan[]' id='keterangan_" + idf + "' style='text-transform: uppercase;'>";
        tr.appendChild(td);
    ...
    function tambahPerjanjian() {
        ...
        td.innerHTML += '<button class="btn" type="button" onclick="hapusPerjanjian(' + idp + ');"><i class="fa-regular fa-trash-can"></i> </button>';
        tr.appendChild(td);

        // Kolom 2 Tanggal Perjanjian
        var td = document.createElement("td");
        td.setAttribute("class", "border border-purple");
        td.innerHTML += '<input type="date" style="width:100%" value="'+tglhariini+'" name="tgl_perjanjian[]" id="tgl_perjanjian_'+idp+'" class="border border-white">';
        tr.appendChild(td);
        ...
        var td = document.createElement("td");
        td.setAttribute("class", "border border-purple");
        td.innerHTML += '<input type="date" style="width:100%" value="'+tglhariini+'" name="awal_perjanjian[]" id="awal_perjanjian_'+idp+'" class="border border-white">';
        tr.appendChild(td);
        
        // Kolom 6 Tanggal Akhir Perjanjian
        var td = document.createElement("td");
        td.setAttribute("class", "border border-purple");
        td.innerHTML += '<input type="date" style="width:100%" value="'+tglhariini+'" name="akhir_perjanjian[]" id="akhir_perjanjian_'+idp+'" class="border border-white">';
        tr.appendChild(td);
    ...
    function tambahInternal() {
        ...
        td.innerHTML += '<button class="btn" type="button" onclick="hapusInternal(' + idi + ');"><i class="fa-regular fa-trash-can"></i> </button>';
        tr.appendChild(td);

        // Kolom 2 Tanggal Internal
        var td = document.createElement("td");
        td.setAttribute("class", "border border-teal");
        td.innerHTML += '<input type="date" style="width:100%" value="'+tglhariini+'" name="tgl_internal[]" id="tgl_internal_'+idi+'" class="border border-white">';
        tr.appendChild(td);
        
        // Kolom 3 Nama Surat Internal
        var td = document.createElement("td");
        td.setAttribute("class", "border border-teal");
        td.innerHTML += "<select name='nminternal[]' style='width:100%;' id='nminternal_" + idi + "' class='form-select' class='border border-white'>"+
        ...
        var td = document.createElement("td");
        td.setAttribute("class", "border border-teal");
        td.innerHTML += '<input type="text" style="width:100%;" name="keterangan_internal[]" id="keterangan_internal_'+idi+'" class="border border-white">';
        tr.appendChild(td);
    ...
    function tambahStatus() {
        ...
        td.innerHTML += '<button class="btn" type="button" onclick="hapusStatus(' + ids + ');"><i class="fa-regular fa-trash-can"></i> </button>';
        tr.appendChild(td);

        // Kolom 2 Tanggal Internal
        var td = document.createElement("td");
        td.setAttribute("class", "border border-pink");
        td.innerHTML += '<input type="date" style="width:100%" value="'+tglhariini+'" name="tgl_status[]" id="tgl_status_'+ids+'" class="border border-white">';
        tr.appendChild(td);
        
        // Kolom 3 Nama Surat Internal
        var td = document.createElement("td");
        td.setAttribute("class", "border border-pink");
        td.innerHTML += "<select name='nmstatus[]' style='width:100%;' id='nmstatus_" + ids + "' class='form-select' class='border border-white'>"+
