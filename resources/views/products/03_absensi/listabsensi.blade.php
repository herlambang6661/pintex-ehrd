                    ...
                    <div class="container-xl">
                        <div class="row g-2 align-items-center">
                            <div class="col">
                                ...
                                <div class="page-pretitle">
                                    <ol class="breadcrumb" aria-label="breadcrumbs">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a href="#"><i class="fa-regular fa-calendar-check"></i> List Absensi</a></li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div class="col-auto ms-auto d-print-none">
                                <div class="btn-list">
                                    <a href="#" class="btn btn-danger d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#modal-lamaran" data-bs-backdrop="static" data-bs-keyboard="false">
                                    ...
                                    <a href="{{ url('absensi/fingerprint'); }}" class="btn btn-primary d-sm-none btn-icon">
                                        <i class="fa-solid fa-fingerprint"></i>
                                    </a>
                                </div>
                            </div>
