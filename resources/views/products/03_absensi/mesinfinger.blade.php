                                        ...
                                        <div class="row row-deck row-cards">
                                            ...
                                            <div class="col-md-6 col-xl-3 col-12">
                                                <div class="card card-sm bg-warning-lt">
                                                    <a href="{{ url('lokal/localabsence') }}" style="text-decoration: none !important;color: inherit;">
                                                        <div class="card-body">
                                                            <div class="row align-items-center">
                                                                <div class="col-auto">
                                                                    <span class="bg-warning text-white avatar">
                                                                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-cell-signal-off"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M20 20h-15.269a.731 .731 0 0 1 -.517 -1.249l7.265 -7.264m2 -2l5.272 -5.272a.731 .731 0 0 1 1.249 .517v11.269" /><path d="M3 3l18 18" /></svg>
                                                                    </span>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="font-weight-medium">
                                                                    ...
                                                                    <div class="text-secondary small lh-base">
                                                                        Opsi untuk Mengelola absensi di Lokal sebelum upload ke Cloud
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-vcenter card-table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>Userinfo</td>
                                                                    <td class="text-secondary">{{ number_format( $count_user_access , 0 , ',' , '.' ) }}</td>
                                                                    <td class="text-secondary">{{ number_format( $count_user_local , 0 , ',' , '.' ) }}</td>
                                                                    <td class="text-secondary">{{ number_format( $count_user_server , 0 , ',' , '.' ) }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Fingerprint</td>
                                                                    <td class="text-secondary">{{ number_format( $count_finger_access , 0 , ',' , '.' ) }}</td>
                                                                    <td class="text-secondary">{{ number_format( $count_finger_local , 0 , ',' , '.' ) }}</td>
                                                                    <td class="text-secondary">{{ number_format( $count_finger_server , 0 , ',' , '.' ) }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
