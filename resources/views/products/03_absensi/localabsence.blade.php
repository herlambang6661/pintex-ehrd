            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <!-- Page pre-title -->
                        <h2 class="page-title">
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-red" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-fingerprint-scan">
                        ...
                        <div class="page-pretitle">
                            <ol class="breadcrumb" aria-label="breadcrumbs">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="#"><i class="fas fa-fingerprint"></i> kelola Absensi <i class="text-red">(Restricted Area)</i></a></li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="row row-deck row-cards">
                            <div class="col-12">
                                <div class="card card-xl shadow rounded">
                                    ...
                                    <table style="width:100%;" class="display text-center table table-vcenter card-table table-sm table-striped table-bordered table-hover text-nowrap datatable-absensi" id="tbabsensi">
                                        <thead>
                                            <tr>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                tableAbsensi = $('.datatable-absensi').DataTable({
                    ...
                    "ajax": {
                        "url": "{{ route('getAbsensiLocal.index') }}",
                        "data": function(data) {
