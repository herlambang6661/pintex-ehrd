                            ...
                            <div class="col">
                                ...
                                <div class="page-pretitle">
                                    <ol class="breadcrumb" aria-label="breadcrumbs">
                                        ...
                                        <li class="breadcrumb-item"><a href="#"><i class="fas fa-fingerprint"></i> Local</a></li>
            ...
            $(function () {
                ...
                var tableMYSQL = $('.datatable-daftar-mysql').DataTable({
                    ...
                    buttons: [
                        ...
                        {
                            className: 'btn btn-info sendSelectedData',
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    // $('.datatable-daftar-mysql').DataTable().ajax.reload();
                                    // $('.datatable-daftar-odbc').DataTable().ajax.reload();
