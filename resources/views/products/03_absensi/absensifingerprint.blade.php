...
@section('content')
    ...
    <div class="page">
        ...
        <script>
            var tableAlpa;
            $(function() {
                tableAlpa = $('#table-finger').DataTable({
                    ...
                    "language": {
                        ...
                        "processing": '<div class="container container-slim py-4"><div class="text-center"><div class=""></div><div class="text-secondary">Loading Data...</div></div></div>',
