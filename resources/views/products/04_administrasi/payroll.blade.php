                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end" style="">
                                                        ...
                                                        <button class="dropdown-item" type="button"
                                                            ...
                                                            data-bs-toggle="popover" title="Langkah 2. Update Data Gaji"
                                                            data-bs-content="untuk perbarui data gaji karyawan ke data payroll. Opsi ini akan memperbarui data tunjangan jabatan, prestasi, potongan koperasi dsb">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                style="margin-right: 5px" height="24"
                                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                                stroke-width="2" stroke-linecap="round"
                                                        ...
                                                        <form action="{{ url('administrasi/tambahanPayroll') }}"
                                                            ...
                                                            <button class="dropdown-item" type="submit"
                                                                ...
                                                                title="Langkah 3. Upload Potongan"
