...
<html lang="en">
    <head>
        ...
        <title>404 PT Plumbon International Textile.</title>
        <!-- CSS files -->
    ...
    <body  class=" border-top-wide border-primary d-flex flex-column">
        ...
        <div class="container-tight py-4">
            <div class="empty">
                <iframe src="https://lottie.host/embed/aaeaf097-b499-48ec-9e93-7fdf7cb2a3db/3TIUkh1TlI.json" width="600px" height="300px"></iframe>
